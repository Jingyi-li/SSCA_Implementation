...
#pragma HLS inline off 
    ...
    sendD(buff0_D[(iter-1)%2], fft2_in_00a, fft2_in_00b);
}
...
// ){
// #pragma HLS inline off 
//     ap_uint<DWIDTH_64> buff0_D[2][Np][M];
//     #pragma HLS bind_storage variable=buff0_D type=RAM_T2P impl=URAM
//     #pragma HLS ARRAY_PARTITION variable=buff0_D complete dim=1
//     #pragma HLS ARRAY_PARTITION variable=buff0_D type=cyclic factor=LANE dim=2
...
//         sendD(buff0_D[(it-1)%2], fft2_in_00a, fft2_in_00b);
//     }
//     sendD(buff0_D[1], fft2_in_00a, fft2_in_00b);
// }
void transpose_B(
...
//     ap_uint<AXI_WIDTH_A> *memintm, ap_uint<AXI_WIDTH_A> *memout
// ){
//     // #pragma HLS DATAFLOW
//     input_D(fft2_in_00a, fft2_in_00b, memintm);
//     output_C(fft2_out_00a, fft2_out_00b, memout);
// }
    ...
    )
{
    ...
    memin, memintm,iter);
    // fft2(
    // fft2_in_00a, fft2_in_00b,
    // fft2_out_00a, fft2_out_00b,
    // memintm, memout);
    input_D(fft2_in_00a, fft2_in_00b, memintm,iter);
    output_C(fft2_out_00a, fft2_out_00b, memout,iter);


    // // input_test(fft1_in_00a, fft1_in_00b, memin, iter);
    // // input_test_coeff(fft1_in_00c, iter2);
    // // output_test(fft1_out_00a, fft1_out_00b, memout, iter);
}
